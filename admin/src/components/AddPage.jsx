...
const AddPage = () => {
  ...
  // this function validated all the fields are filled or not with correct details
  function validate() {
  ...
  async function handleSubmit(e) {
    ...
    // if the movietype === latesttrailers then it will create a latesttrailwerOBJ
    if (movieType === "latestTrailers") {
    ...
    try {
      ...
      if (resp?.data?.success) {
        ...
        toast.error(resp?.data?.message || "Unexpected error form server");
      }
    } catch (err) {

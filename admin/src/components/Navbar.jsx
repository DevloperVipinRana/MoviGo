      ...
      <div className={styles4.navbarContainer}>
        <div className={styles4.navbarFlex}>
          ...
          <div className={styles4.logoContainer}>
            ...
            <span className={styles4.logoText}>MOVIGO</span>
          </div>
        ...
        >
          <div className={styles4.mobileMenuPanelHeader}>
            <div className={styles4.logoContainer}>
              ...
              <span className="font-['Impact'] text-white tracking-wider">
                MOVIGO
              </span>
            </div>
            <button
          ...
          <nav className={styles4.mobileMenuPanelNav}>
            ...
            >
              {({ isActive }) => (
                <>
                  <Film
                    className={`${styles4.mobileNavLinkIconBase} ${isActive ? styles4.mobileNavLinkIconActive : styles4.mobileNavLinkIconInactive}`}
                  />
          ...
          <div className={styles4.mobileMenuPanelFooter}>
              <p className={styles4.mobileMenuFooterText}>
                &copy; {new Date().getFullYear()} MOVIGO
              </p>
          </div>
        </aside>
      </div>
